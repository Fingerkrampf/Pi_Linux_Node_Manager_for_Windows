...
"""
Pi Linux Node Manager for Windows v1.0
...
Pi Linux Node Manager für Windows v1.0
Copyright (C) 2025 Fingerkrampf
...
translations = {
    "de": {
        "title": "Pi Linux Node Manager für Windows v1.0 von Fingerkrampf @ t.me/PiNetzwerkDeutschland",
    ...
    "en": {
        "title": "Pi Linux Node Manager for Windows v1.0 by Fingerkrampf @ t.me/PiNetzwerkDeutschland",
...
class PiNodeGUI(ctk.CTk):
    ...
    def setup_ui(self):
        self.title("Pi Linux Node Manager for Windows v1.0")
        ...
        self.status_frame.grid(row=0, column=0, padx=20, pady=(20, 10), sticky="w")
        ...
        self.log_label.grid(row=2, column=0, padx=20, pady=(10, 5), sticky="w")
        self.log_text_frame = ctk.CTkFrame(main_frame, corner_radius=10)
        self.log_text_frame.grid(row=3, column=0, padx=20, pady=(0, 20), sticky="nsew")
